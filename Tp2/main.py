...
from genetic import generate_start_population, select, check_end_condition, avg_performance, calculate_diversity
...
def run_main_2(config):
    ...
    while not end:
        mean_performances.append(avg_performance(previous_population))
        diversities.append(calculate_diversity(previous_population))
    ...
    return mean_performances, diversities, generation, end_condition
